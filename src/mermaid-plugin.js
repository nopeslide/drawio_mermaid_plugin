...
`;
  ...
  this.addPaletteFunctions('mermaid', 'Mermaid', true, [
    ...
    this.createVertexTemplateEntry(style, 500, 300, sequence, 'Sequence Diagram', null, null, this.getTagsForStencil('mxgraph.mermaid.abstract', 'mermaid', 'sequence ').join(' ')),
    ...
    this.createVertexTemplateEntry(style, 700, 300, journeyDiagram, 'User Journey Diagram', null, null, this.getTagsForStencil('mxgraph.mermaid.abstract', 'mermaid', 'journey', 'user ').join(' ')),
